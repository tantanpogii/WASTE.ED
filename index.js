...
const wasteTypes = [
    ...
    "Metal Waste", "Paper & Cardboard", "Hazardous Waste", "Textile Waste"
];

const recyclingMethods = [
    "Composting", "Plastic Recycling", "Upcycling", "E-Waste Disposal", 
    "Glass Reuse", "Metal Scrapping", "Paper Recycling", "Biodegradable Packaging"
];
...
wasteTypes.forEach( img => addSlidingPlace(img, countriesContainer))
wasteTypes.forEach( img => addSlidingPlace(img, countriesContainer))

recyclingMethods.forEach( img => addSlidingPlace(img, placeContainer))
recyclingMethods.forEach( img => addSlidingPlace(img, placeContainer))
recyclingMethods.forEach( img => addSlidingPlace(img, placeContainer))
